...
import kr.khs.studyfarm.databinding.ButtonLevelSelectLineBinding
import kr.khs.studyfarm.setting
import kotlin.math.max
import kotlin.math.min

class LevelSelectLineButton @JvmOverloads constructor(
    context : Context, attrs : AttributeSet? = null, defStyle: Int = 0
) : ConstraintLayout(context, attrs, defStyle) {

    private var binding : ButtonLevelSelectLineBinding
    ...
    val textLevelSelect : TextView
        get() = binding.root.levelselectline_tv_select
    ...
    private val selectNumber = ObservableField<String>()
...
//    private var endIdx = 0
    ...
    init {
        ...
        binding = DataBindingUtil.inflate(
            inflater, R.layout.button_level_select_line, this, true
        )
        binding.view = this
...
//        addView(view)
    ...
    private fun initViews() {
        btnLevelOne = binding.root.findViewById(R.id.levelselectline_button_level1)
        btnLevelTwo = binding.root.findViewById(R.id.levelselectline_button_level2)
        btnLevelThree = binding.root.findViewById(R.id.levelselectline_button_level3)
        btnLevelFour = binding.root.findViewById(R.id.levelselectline_button_level4)

        textLevelOne = binding.root.findViewById(R.id.levelselectline_tv_level1)
        textLevelTwo = binding.root.findViewById(R.id.levelselectline_tv_level2)
        textLevelThree = binding.root.findViewById(R.id.levelselectline_tv_level3)
        textLevelFour = binding.root.findViewById(R.id.levelselectline_tv_level4)

        lineOne = binding.root.findViewById(R.id.levelselectline_line1)
        lineTwo = binding.root.findViewById(R.id.levelselectline_line2)
        lineThree = binding.root.findViewById(R.id.levelselectline_line3)
    }

    private fun initAttrs(attrs : AttributeSet?) {
        attrs?.run {
            context.obtainStyledAttributes(this, R.styleable.LevelSelectLineButton)
        }?.run {
            levelOneName = getString(R.styleable.LevelSelectLineButton_levelOneNameLine) ?: levelOneName
            levelTwoName = getString(R.styleable.LevelSelectLineButton_levelTwoNameLine) ?: levelTwoName
            levelThreeName = getString(R.styleable.LevelSelectLineButton_levelThreeNameLine) ?: levelThreeName
            levelFourName = getString(R.styleable.LevelSelectLineButton_levelFourNameLine) ?: levelFourName

            isRange = getBoolean(R.styleable.LevelSelectLineButton_range, isRange)
        }
    }
