...
public final class BindingUtilKt {
    ...
    kr.khs.studyfarm.view.custom.LevelSelectButton $this$setting, int level) {
    }
    
    @androidx.databinding.BindingAdapter(value = {"app:levelSelectButtonChanged"})
    ...
    @androidx.databinding.InverseBindingAdapter(attribute = "app:levelSelectButtonSetting", event = "app:levelSelectButtonChanged")
    public static final int getLevel(@org.jetbrains.annotations.NotNull()
