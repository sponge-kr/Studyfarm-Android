...
public class SignupInfoFragmentArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private SignupInfoFragmentArgs() {
  }

  private SignupInfoFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static SignupInfoFragmentArgs fromBundle(@NonNull Bundle bundle) {
    SignupInfoFragmentArgs __result = new SignupInfoFragmentArgs();
    bundle.setClassLoader(SignupInfoFragmentArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    SignupInfoFragmentArgs that = (SignupInfoFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(SignupInfoFragmentArgs original) {
      this.arguments.putAll(original.arguments);
    }

    public Builder(int seq, @Nullable SelectInfo[] cities, @Nullable SelectInfo[] interested) {
    ...
    @NonNull
    public SignupInfoFragmentArgs build() {
      SignupInfoFragmentArgs result = new SignupInfoFragmentArgs(arguments);
      return result;
    }
