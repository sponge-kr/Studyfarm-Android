...
public class LayoutSignupStep2BindingImpl extends LayoutSignupStep2Binding implements kr.khs.studyfarm.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener mboundView7levelSelectButtonAttrChanged1 = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.interestingRating.get()[0]
            //         is androidx.databinding.ViewDataBinding.setTo(viewModel.interestingRating.get(), 0, callbackArg_0)
            java.lang.String callbackArg_0 = kr.khs.studyfarm.BindingUtilKt.getLevel(mboundView7);
            // localize variables for thread safety
            // viewModel.interestingRating != null
            boolean viewModelInterestingRatingJavaLangObjectNull = false;
            // viewModel
            kr.khs.studyfarm.login_process.sign_up_info.SignupInfoViewModel viewModel = mViewModel;
            // viewModel.interestingRating
            androidx.databinding.ObservableField<java.util.ArrayList<java.lang.String>> viewModelInterestingRating = null;
            // viewModel.interestingRating.get()[0]
            java.lang.String viewModelInterestingRating0 = null;
            // viewModel != null
            boolean viewModelJavaLangObjectNull = false;
            // viewModel.interestingRating.get()
            java.util.ArrayList<java.lang.String> viewModelInterestingRatingGet = null;
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                viewModelInterestingRatingJavaLangObjectNull = (viewModelInterestingRating) != (null);
                if (viewModelInterestingRatingJavaLangObjectNull) {
                    ...
                    androidx.databinding.ViewDataBinding.setTo(viewModelInterestingRatingGet, 0, callbackArg_0);
                }
            }
        }
    };
    private androidx.databinding.InverseBindingListener mboundView8levelSelectButtonAttrChanged1 = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.interestingRating.get()[1]
            //         is androidx.databinding.ViewDataBinding.setTo(viewModel.interestingRating.get(), 1, callbackArg_0)
            java.lang.String callbackArg_0 = kr.khs.studyfarm.BindingUtilKt.getLevel(mboundView8);
            // localize variables for thread safety
            // viewModel.interestingRating != null
            boolean viewModelInterestingRatingJavaLangObjectNull = false;
            // viewModel
            ...
            // viewModel.interestingRating
            androidx.databinding.ObservableField<java.util.ArrayList<java.lang.String>> viewModelInterestingRating = null;
            // viewModel.interestingRating.get()[1]
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                if (viewModelInterestingRatingJavaLangObjectNull) {
                    ...
                    androidx.databinding.ViewDataBinding.setTo(viewModelInterestingRatingGet, 1, callbackArg_0);
                }
            }
        }
    };
    private androidx.databinding.InverseBindingListener mboundView9levelSelectButtonAttrChanged1 = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.interestingRating.get()[2]
            //         is androidx.databinding.ViewDataBinding.setTo(viewModel.interestingRating.get(), 2, callbackArg_0)
            java.lang.String callbackArg_0 = kr.khs.studyfarm.BindingUtilKt.getLevel(mboundView9);
            // localize variables for thread safety
            // viewModel.interestingRating != null
            boolean viewModelInterestingRatingJavaLangObjectNull = false;
            // viewModel.interestingRating.get()[2]
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                if (viewModelInterestingRatingJavaLangObjectNull) {
                    ...
                    androidx.databinding.ViewDataBinding.setTo(viewModelInterestingRatingGet, 2, callbackArg_0);
                }
            }
        }
    };
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeViewModelInterestingRating((androidx.databinding.ObservableField<java.util.ArrayList<java.lang.String>>) object, fieldId);
            case 2 :
                return onChangeViewModelStudyTexts((androidx.lifecycle.MutableLiveData<java.lang.String[]>) object, fieldId);
            case 3 :
    ...
    private boolean onChangeViewModelInterestingRating(androidx.databinding.ObservableField<java.util.ArrayList<java.lang.String>> ViewModelInterestingRating, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeViewModelStudyTexts(androidx.lifecycle.MutableLiveData<java.lang.String[]> ViewModelStudyTexts, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<java.lang.String[]> viewModelStudyTexts = null;
        ...
        if ((dirtyFlags & 0x1ffL) != 0) {
            ...
            if ((dirtyFlags & 0x182L) != 0) {
                    ...
                    if (viewModelInterestingRatingGet != null) {
                        ...
                        viewModelInterestingRating1 = getFromList(viewModelInterestingRatingGet, 1);
                        // read viewModel.interestingRating.get()[2]
                        viewModelInterestingRating2 = getFromList(viewModelInterestingRatingGet, 2);
                        // read viewModel.interestingRating.get()[0]
                        viewModelInterestingRating0 = getFromList(viewModelInterestingRatingGet, 0);
                    }
            }
        ...
        if ((dirtyFlags & 0x100L) != 0) {
            ...
            kr.khs.studyfarm.BindingUtilKt.onChange(this.mboundView7, mboundView7levelSelectButtonAttrChanged1);
            kr.khs.studyfarm.BindingUtilKt.onChange(this.mboundView8, mboundView8levelSelectButtonAttrChanged1);
            kr.khs.studyfarm.BindingUtilKt.onChange(this.mboundView9, mboundView9levelSelectButtonAttrChanged1);
        ...
        if ((dirtyFlags & 0x184L) != 0) {
            ...
            this.mboundView7.setTargetName(viewModelStudyTexts0);
            this.mboundView8.setTargetName(viewModelStudyTexts1);
            this.mboundView9.setTargetName(viewModelStudyTexts2);
        }
        if ((dirtyFlags & 0x182L) != 0) {
            // api target 1

            kr.khs.studyfarm.BindingUtilKt.setting(this.mboundView7, viewModelInterestingRating0);
            kr.khs.studyfarm.BindingUtilKt.setting(this.mboundView8, viewModelInterestingRating1);
            kr.khs.studyfarm.BindingUtilKt.setting(this.mboundView9, viewModelInterestingRating2);
        }
        if ((dirtyFlags & 0x181L) != 0) {
            // api target 1
